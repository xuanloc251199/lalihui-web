...
<html lang="en">
    ...
    <body>
        <header class="header d-flex flex-wrap align-items-center" data-page="wishlist" data-overlay="@@overlay">
        ...
        <header class="page">
            <div class="page_main container-fluid">
                <div class="container">
                    <h1 class="page_header">Wishlist</h1>
        ...
        <main>
            ...
            <div class="products section--nopb">
                <div class="container">
                    <ul class="products_list d-sm-flex flex-wrap">
                        <li class="products_list-item col-sm-6 col-lg-4 col-xl-3" data-order="1">
                            <div class="products_list-item_wrapper d-flex flex-column">
                                <div class="media">
                                    <picture>
                                        <source data-srcset="https://dummyimage.com/310x217/d6d6d6/fff" srcset="https://dummyimage.com/310x217/d6d6d6/fff" type="image/webp" />
                                        <img
                                            class="lazy preview"
                                            data-src="https://dummyimage.com/310x217/d6d6d6/fff"
                                            src="https://dummyimage.com/310x217/d6d6d6/fff"
                                            alt="High CBD 50 Oil"
                                        />
                                    </picture>
                                    <div class="overlay d-flex justify-content-between align-items-start">
                                        <div class="action d-flex flex-column">
                                            ...
                                            <a class="action_link active d-flex align-items-center justify-content-center" href="#">
                                                <i class="icon-heart"></i>
                                            </a>
                                        </div>
                                    </div>
