            ...
            <div class="container d-md-flex justify-content-between">
                    ...
                    <ul class="news_list">
                        <li class="news_list-item">
                            ...
                            <div class="main">
                                ...
                                <a class="main_link btn--underline" href="post.php">Read more</a>
                            </div>
                        </li>
                        <li class="news_list-item">
                            <div class="media">
                ...
                <div class="widgets">
                    ...
                    <div class="widgets-item widgets-item--recent">
                        ...
                        <ul class="list">
                            <li class="list-item">
                                <a class="d-flex flex-column flex-sm-row align-items-sm-center" href="post.php">
                                    <span class="media">
                                        <picture>
                                            <source
                                    ...
                                    <span class="wrapper">
                                        ...
                                        <span class="metadata d-flex align-items-center"
                                            ><i class="icon-calendar_day icon"></i>September 30, 2024</span
                                        >
                                    </span>
                                </a>
                            </li>
