...
<html lang="en">
    ...
    <body>
        <header class="header d-flex flex-wrap align-items-center" data-page="contacts" data-overlay="@@overlay">
            ...
            <div class="contacts section">
                <div class="container d-flex flex-wrap flex-xl-nowrap justify-content-between">
                    <div class="contacts_form col-12 col-lg-5">
                        ...
                        <form class="contacts_form-form d-flex flex-column" data-type="feedback" action="#" method="post">
                    ...
                    <div class="contacts_info col-12 col-lg-6 col-xl-auto flex-xl-grow-1">
                        <div class="contacts_info-map">
                            <div id="map">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.462922455203!2d105.74664758513305!3d21.054165336904028!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454e5cbde5911%3A0x58e15e18f3a4ee0a!2zS2h1IMSR4bqldSBnacOhLCAxIMSQLiDEkOG7qWMgRGnhu4VuLCBQaMO6YyBEaeG7hW4sIELhuq9jIFThu6sgTGnDqm0sIEjDoCBO4buZaSwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1724030633733!5m2!1svi!2s" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
