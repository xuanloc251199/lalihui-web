                ...
                <ul class="cartOffcanvas_body-list">
                    <li class="cartOffcanvas_body-list_item d-sm-flex align-items-center">
                        <div class="media">
                            <a href="product.php" target="_blank" rel="noopener norefferer">
                                <picture>
                                    <source data-srcset="https://dummyimage.com/620x430/cfcfcf/fff" srcset="https://dummyimage.com/620x430/cfcfcf/fffg" type="image/webp" />
                                    <img class="lazy" data-src="https://dummyimage.com/620x430/cfcfcf/fffg" src="https://dummyimage.com/620x430/cfcfcf/fffg" alt="media" />
                                </picture>
                            </a>
                        </div>
                    ...
                    <li class="cartOffcanvas_body-list_item d-sm-flex align-items-center">
                        <div class="media">
                            <a href="product.php" target="_blank" rel="noopener norefferer">
                                <picture>
                                    <source data-srcset="https://dummyimage.com/620x430/cfcfcf/fffg" srcset="https://dummyimage.com/620x430/cfcfcf/fff" type="image/webp" />
                                    <img class="lazy" data-src="https://dummyimage.com/620x430/cfcfcf/fff" src="https://dummyimage.com/620x430/cfcfcf/fff" alt="media" />
                                </picture>
                            </a>
                        </div>
                        <div class="main d-flex flex-wrap justify-content-between align-items-end align-items-lg-center">
                    ...
                    <li class="cartOffcanvas_body-list_item d-sm-flex align-items-center">
                        <div class="media">
                            <a href="product.php" target="_blank" rel="noopener norefferer">
                                <picture>
                                    <source data-srcset="https://dummyimage.com/620x430/cfcfcf/fff" srcset="https://dummyimage.com/620x430/cfcfcf/fff" type="image/webp" />
                                    <img class="lazy" data-src="https://dummyimage.com/620x430/cfcfcf/fff" src="https://dummyimage.com/620x430/cfcfcf/fff" alt="media" />
                                </picture>
                            </a>
                        </div>
