<?php
    // Step 1: Check if 'id' exists in the URL
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        $product_id = $_GET['id'];

        // Step 2: Sanitize the product ID
        $product_id = intval($product_id);

        // Step 3: Connect to your database
        include './config/connect_db.php'; // Replace with your actual connection file

        // Step 4: Query to fetch the product information by ID
        $sql = "SELECT * FROM products WHERE id = $product_id";
        $result = $conn->query($sql);

        if ($result && $result->num_rows > 0) {
            $row = $result->fetch_assoc(); // Lưu kết quả vào biến $row
        } else {
            echo "Không tìm thấy sản phẩm.";
            exit;
        }

        // Step 6: Fetch product images from prd_image table
        $image_sql = "SELECT * FROM prd_image WHERE id_prd = $product_id";
        $image_result = $conn->query($image_sql);

        $product_images = [];
        if ($image_result->num_rows > 0) {
            while ($image_row = $image_result->fetch_assoc()) {
                $product_images[] = $image_row['name_image'];
            }
        }
    } else {
        echo "Invalid product ID.";
        exit; // Exit if no valid product ID provided
    }
?>
...
<html lang="en">
    <head>
        ...
        <title><?php echo $row["prd_name"]; ?>| Lalihui</title>
    ...
    <body>
        ...
        <header class="page">
            <div class="page_main container-fluid">
                <div class="container">
                    <h1 class="page_header"><?php echo $row["prd_name"]; ?></h1>
                    <p class="page_text"><?php echo $row["detail"]; ?></p>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="about_main d-lg-flex flex-nowrap">
                                    ...
                                    <?php if (!empty($product_images)) { ?>
                                        <?php foreach ($product_images as $image) { ?>
                                            <div class="swiper-slide">
                                                <picture>
                                                    <source
                                                        data-srcset="./img/products/<?php echo $image; ?>"
                                                        srcset="./img/products/<?php echo $image; ?>"
                                                        type="image/webp"
                                                    />
                                                    <img
                                                        class="lazy"
                                                        data-src="./img/products/<?php echo $image; ?>"
                        ...
                        <div class="about_main-info">
                            <div class="about_main-info_product d-sm-flex align-items-center justify-content-between">
                                <?php if (isset($row['prd_name'])) { ?>
                                    <h2 class="title"><?php echo $row["prd_name"]; ?></h2>
                                <?php } else { ?>
                                    <h2 class="title">Tên sản phẩm không khả dụng</h2>
                                <?php } ?>
                            ...
                            <span class="about_main-info_price"><?php echo number_format($row["price"], 0, ',', '.') . ' VND'; ?></span>
                                            ...
                                            <ul class="reviews-section_list">
                                                <li class="review">
                                                    <div class="review_header d-sm-flex flex-wrap">
                                                        ...
                                                        <span class="timestamp">September 30, 2024 at 9:52 am</span>
                                                    </div>
                                                    <p class="review_main">
                                                ...
                                                <li class="review">
                                                    <div class="review_header d-sm-flex flex-wrap">
                                                        ...
                                                        <span class="timestamp">October 1, 2024 at 11:52 am</span>
                                                    </div>
                    ...
                    <ul class="top_list d-lg-flex flex-wrap">
                        ...
                        <li class="top_list-item col-lg-6" data-order="2">
                            <div class="top_list-item_wrapper d-flex flex-column flex-sm-row flex-lg-column flex-xxl-row">
                                ...
                                <div class="main d-md-flex flex-column">
                                    <a class="main_title" href="product.php" target="_blank" rel="noopener norefferer">Black Dog</a>
                                    <ul class="main_table d-flex flex-column">
                                        <li class="list-item">
                                            <span class="property">THC</span>
                                            <span class="value">110.00-160.00%</span>
                        ...
                        <li class="top_list-item col-lg-6" data-order="4">
                            <div class="top_list-item_wrapper d-flex flex-column flex-sm-row flex-lg-column flex-xxl-row">
                                ...
                                <div class="main d-md-flex flex-column">
                                    <a class="main_title" href="product.php" target="_blank" rel="noopener norefferer">Ace Of Spade</a>
                                    <ul class="main_table d-flex flex-column">
                                        <li class="list-item">
                                            <span class="property">THC</span>
                                            <span class="value">110.00-160.00%</span>
