...
<html lang="en">
    <head>
        ...
        <title>Benefits of CBD Extract for Health | Lalihui</title>
                        ...
                        <div class="main">
                            <div class="panel d-flex flex-column flex-md-row align-items-md-center">
                                <div class="wrapper flex-grow-1 d-md-flex flex-md-row">
                                    ...
                                    <span class="panel_timestamp">September 30, 2024 at 9:52 am</span>
                                </div>
                        ...
                        <div class="main">
                            <div class="panel d-flex flex-column flex-md-row align-items-md-center">
                                <div class="wrapper flex-grow-1 d-md-flex flex-md-row">
                                    ...
                                    <span class="panel_timestamp">September 30, 2024 at 10:58 am</span>
                                </div>
                                <a class="panel_btn btn--underline" href="#">Reply</a>
                            </div>
                            <p class="text">
